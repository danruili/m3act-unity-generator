...
public class AnimClipsManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            PlayClip(0, GetGroupByName("Fighting").RandomClipName(), 0.1f, Random.Range(0f,1f));
        }
    ...
    //        {
    //            controller.AddMotion(mbt.GenerateBlendTree());
