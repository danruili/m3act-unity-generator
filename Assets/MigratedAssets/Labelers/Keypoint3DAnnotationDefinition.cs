...
/// </summary>
public class Keypoint3DAnnotationDefinition : AnnotationDefinition
{
    internal const string labelerDescription = "Produces 3D keypoint annotations for all visible labeled objects that have a humanoid animation avatar component.";
    ...
    internal Keypoint3DAnnotationDefinition(string id, Template template)
        : base(id)
    {
